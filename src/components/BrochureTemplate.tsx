        ...
        <div ref={ref} className="w-[800px] h-auto bg-white text-slate-800 font-sans absolute top-[-9999px] left-[-9999px] p-8" id="brochure-content">
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xl font-bold tracking-tight text-slate-900">SFT</span>
                </div>
            ...
            <div className="relative w-full h-[350px] rounded-2xl overflow-hidden mb-8">
                ...
                <div className="absolute bottom-6 right-6 text-white text-right">
                    ...
                    <p className="text-sm font-bold">SFT Corporate</p>
                </div>
            </div>
            ...
            <p className="text-[8px] text-center text-slate-400 mt-4 italic">This brochure was automatically generated by SFT AI. Data as of 2026.</p>
        </div>
    );
});
