        ...
        <div className="space-y-6 animate-in fade-in duration-500 max-w-6xl mx-auto pb-24 px-4 text-navy">
            ...
            <div className="flex justify-between items-center bg-white/50 backdrop-blur-md p-6 sticky top-20 z-10 border-b border-gray-100 mb-6 rounded-2xl shadow-sm">
                <div>
                    ...
                    <h1 className="text-3xl font-extrabold text-navy tracking-tight">Add New <span className="text-teal">Workspace</span></h1>
                </div>
                <div className="flex gap-4">
                    ...
                    <Button onClick={handleSubmit} disabled={submitting} className="bg-teal hover:bg-teal/90 text-white shadow-xl shadow-teal/20 rounded-xl px-10 font-bold h-12">
                        {submitting ? "Publishing..." : <><Save className="w-4 h-4 mr-2" /> Publish Space</>}
                    </Button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Main Content Column */}
                <div className="lg:col-span-2 space-y-8 text-navy">
                    ...
                    <Card className="rounded-3xl border-none shadow-sm overflow-hidden text-navy">
                        ...
                        <CardContent className="p-8 space-y-6">
                            <div className="space-y-2">
                                ...
                                <Input id="name" value={formData.name} onChange={handleChange} placeholder="e.g. WeWork Galaxy" className="h-12 bg-gray-50 border-none rounded-xl" />
                            </div>

                            <div className="space-y-3">
                                <Label className="text-navy font-semibold">Workspace Categories (Select one or more)</Label>
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Tell us about the space, vibes, and environment..."
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="location" value={formData.location} onChange={handleChange} placeholder="e.g. Koramangala / BKC" className="h-12 bg-gray-50 border-none rounded-xl" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-[10px] text-gray-400">Past the full Google Maps sharing link here.</p>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="p-8 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-navy/5 p-6 rounded-2xl border border-navy/10">
                                <div className="space-y-2">
                                    ...
                                    <Input id="snapshot.capacity" value={formData.snapshot.capacity} onChange={handleChange} placeholder="e.g. 50 Seats" className="h-11 bg-white border-navy/10 rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Snapshot: Area</Label>
                                    <Input id="snapshot.area" value={formData.snapshot.area} onChange={handleChange} placeholder="e.g. 2500 Sq. Ft." className="h-11 bg-white border-navy/10 rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Snapshot: Lock In</Label>
                                    <Input id="snapshot.lock_in" value={formData.snapshot.lock_in} onChange={handleChange} placeholder="e.g. 12 Months" className="h-11 bg-white border-navy/10 rounded-xl" />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input id="tech.floorToCeiling" value={formData.technicalSpecs.floorToCeiling} onChange={handleChange} placeholder="e.g. 3.2 Meters" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Passenger Lifts</Label>
                                    <Input id="tech.passengerLifts" type="number" value={formData.technicalSpecs.passengerLifts} onChange={handleChange} placeholder="0" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Service Lifts</Label>
                                    <Input id="tech.serviceLifts" type="number" value={formData.technicalSpecs.serviceLifts} onChange={handleChange} placeholder="0" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                    ...
                    <Card className="rounded-3xl border-none shadow-sm overflow-hidden text-navy">
                        <CardHeader className="bg-gray-50/50 pb-4">
                            <CardTitle className="text-xl font-bold flex items-center gap-2"><ArrowLeft className="w-5 h-5 text-teal rotate-180" /> Detailed Commercials</CardTitle>
                        </CardHeader>
                        <CardContent className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Basement (₹/SqFt)</Label>
                                    <Input id="comm.rentPSFT" value={formData.commercialDetails.rentPSFT} onChange={handleChange} placeholder="95" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">CAM Charges (₹/SqFt)</Label>
                                    <Input id="comm.camCharges" value={formData.commercialDetails.camCharges} onChange={handleChange} placeholder="12" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Lock-in Period</Label>
                                    <Input id="comm.lockInPeriod" value={formData.commercialDetails.lockInPeriod} onChange={handleChange} placeholder="36 Months" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs uppercase text-navy/60 font-black">Rent Escalation (%)</Label>
                                    <Input id="comm.escalation" value={formData.commercialDetails.escalation} onChange={handleChange} placeholder="5% Bi-Annual" className="h-11 bg-gray-50 border-none rounded-xl" />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-3xl border-none shadow-sm overflow-hidden text-navy">
                        ...
                        <CardContent className="p-8 space-y-10">
                            ...
                            <ListEditor
                                ...
                                fields={[
                                    { key: "component", label: "Component (e.g. Electricity)" },
                                    { key: "cost", label: "Cost (e.g. ₹15/Unit)" },
                ...
                <div className="space-y-8">
                    ...
                    <Card className="rounded-3xl border-none shadow-sm overflow-hidden">
                        ...
                        <CardContent className="p-6">
                            <MultiImageUpload
                                ...
                                maxImages={10}
                                maxSizeMB={10}
                                label="Upload building and interior photos"
                            />
                            <p className="text-[10px] text-gray-400 mt-4 leading-relaxed">
                                Upload up to 10 images. Max size 10MB per image. The first image will be your primarily thumbnail.
                            </p>
                        </CardContent>
                    </Card>

                    {/* Final CTA in Sidebar for mobile/small screens or as extra convenience */}
                    <div className="p-2 space-y-4">
                        ...
                        >
                            {submitting ? "Publishing..." : "Publish Workspace Now"}
                        </Button>
                        <p className="text-center text-xs text-gray-400">
                            By publishing, you agree to our partner terms and data accuracy policies.
                        </p>
                    </div>
                </div>
            </div>
